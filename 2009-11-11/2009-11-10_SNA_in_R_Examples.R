...
png("01_rstats.png",height=1500,width=1500,res=100,pointsize=14)
...
png("02_rstats_distant.png",height=1500,width=1500,res=100,pointsize=20)
...
png("04_rstats_dendrogram.png",height=1500,width=1500,res=100,pointsize=20)
plot(dend)
dev.off()
...
png("05_rstats_block_model.png",height=1500,width=1500,res=100,pointsize=20)
plot(block.model,layout=block.layout,vertex.size=10)
dev.off()
png("06_rstats_block_model_size.png",height=1500,width=1500,res=100,pointsize=20)
plot(block.model,layout=block.layout,vertex.size=block.size)
dev.off()
png("07_rstats_block_model_density.png",height=1500,width=1500,res=100,pointsize=20)
...
png("08_rstats_key_block.png",height=1500,width=1500,res=100,pointsize=20)
